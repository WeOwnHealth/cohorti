...
/**
 * Immutable execution trace — OpenTelemetry to an audit store, digest
 * anchored on-chain via contracts/evm/src/AuditAnchor.sol. Exclusions are
 * captured with the same weight as inclusions: README.md is explicit that
 * "a wrongly excluded eligible patient is invisible unless exclusions are
 * logged."
 */
